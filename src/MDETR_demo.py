...
def plot_inference(im, caption, save_fig_path, gt_bbox):
    ...
    idx_filt = filter_by_area(bboxes_scaled, im.size)
    ...
    #conf_score = selected_score.cpu().detach().numpy().astype(float)
...
results_path = "/home/falag/Desktop/new_analysis/MDETR_captions_tests"
metrics_path = "/home/falag/Desktop/new_analysis/MDETR_captions_tests/Metrics_files"
# ++++++++++++++++++++++++++++++++
        ...
        for folder in folders:
            ...
            for object in obj_folders:
                ...
                for j in range(len(images)):
                    ...
                    # Run the inference
                    accuracy, iou_val, pred_box, labels = plot_inference(im, caption, save_fig_path, gt_bbox)
